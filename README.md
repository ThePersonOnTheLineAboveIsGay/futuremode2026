...
| 方案評估（雙方比較） | 討論還在比較做法 | 「那我們就打黑客松，不做原本那個方向了。」 | 「🤖 AI 提醒：原方向前面提到的優勢是＿＿；黑客松這邊目前提到的考量是＿＿。兩邊都還沒有結論，要不要先確認取捨？」（AI 只列雙方已提過的論點與風險，不會替團隊下結論說哪個比較好） |
| 方案評估（單一提案可行性） | 無需事先比較 | 「我打算明天一天內做出一片 DDR5 RAM。」 | 「🤖 AI 提醒：這個時程對硬體開發來說相當緊迫，一天內完成通常不太可行，要不要先確認範圍或時間安排？」（不需要有對照方案，單一提案只要時程／成本／技術可行性有明顯疑慮就會提出） |
