...
**Meet AI 插話員是 Google Meet 裡的即時會議品質副駕：它聽懂討論，在有人前後說法矛盾、明顯離題、有可核對的邏輯問題，或提出具體方案／決定時，溫和地提醒團隊把話說清楚、把取捨想清楚。**

它不是會議錄影工具、不是 Meet 字幕的換皮，也不是會在每句話後面評論的聊天機器人。它的價值是讓討論在「決策即將失焦」的當下，被自然地拉回可驗證的脈絡。

### 影片應傳達的三個核心感受

1. **即時但不粗暴**：提醒在對話進行中出現，語氣是「要不要說明原因？」而不是判定某人犯錯。
...
AI 將完整語音段落轉成繁體中文逐字稿
        ↓
比對近期會議脈絡，判斷是否有明確矛盾／離題／邏輯問題／未下結論的方案取捨
        ↓
...
| 方案評估 | 討論還在比較做法 | 「那我們就打黑客松，不做原本那個方向了。」 | 「🤖 AI 提醒：原方向前面提到的優勢是＿＿；黑客松這邊目前提到的考量是＿＿。兩邊都還沒有結論，要不要先確認取捨？」（AI 只列雙方已提過的論點與風險，不會替團隊下結論說哪個比較好） |

### 不應誤導觀眾的地方

- 不要說「AI 監聽所有人」或「精準辨識每個人」。主要來源只聽本機使用者的麥克風；分頁混音是匿名備援。
- 不要說「會自動糾正／判定誰錯了」，也不要說「AI 會告訴你哪個方案比較好」。方案評估類型只列出逐字稿裡出現過的雙方論點與風險，不會下結論，是否採納由人決定。
...
- Extension 會偵測聲音開始與停頓，只送出完整語音段落。目標長度約 30 秒；30 秒內只有明顯停頓（約 2.5 秒沒聲音，判斷是講完了而不是換氣）才會提前切段，時間到了也不會硬切在句子中間，會等到下一次自然停頓才送出；真的完全不停頓時，90 秒是保底的安全上限。
